...
function draw() {
    ...
    if(hands.length > 0 && introTrans < 50){
        ...
        if(pinch < 20){image(handPinch, centerX * vwidth, centerY * vheight - 20, 50, 50); if(detectGrab()){grab = true}} else {image(handPinchOpen, centerX * vwidth, centerY * vheight, 50, 50); grab = false;}
